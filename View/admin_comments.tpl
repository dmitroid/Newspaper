    ...
    <table border="1" class="table" >
        ...
        {foreach $comments as $comment}
            <tr>
                ...
                <td><a href="/admin/comment/show/{$comment['id']}">{$comment['comment']} <span style="font-size: 12px">(Edit)</span></a></td>
                <td><a href="/admin/item/show/{$comment['item_id']}"><i class="glyphicon glyphicon-eye-open"></i> {$comment['name']}</a></td>
